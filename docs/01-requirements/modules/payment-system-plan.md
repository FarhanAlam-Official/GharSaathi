...
1. ☐ `src/main/java/com/gharsaathi/payment/repository/PaymentRepository.java`

### Exceptions (4 files)

1. ☐ `src/main/java/com/gharsaathi/payment/exception/PaymentNotFoundException.java`
...
1. ☐ `src/main/java/com/gharsaathi/common/dto/PaymentRequest.java`
...
1. ☐ `src/main/java/com/gharsaathi/payment/service/PaymentService.java`
2. ☐ `src/main/java/com/gharsaathi/payment/scheduler/PaymentOverdueScheduler.java`

### Controller (1 file)

1. ☐ `src/main/java/com/gharsaathi/payment/controller/PaymentController.java`

### Documentation (1 file)

1. ☐ `backend/tests/PAYMENT_MODULE_API_TESTS.txt`

### Modified Files (2 files)

1. ☐ `src/main/java/com/gharsaathi/lease/service/LeaseService.java` (MODIFY)
